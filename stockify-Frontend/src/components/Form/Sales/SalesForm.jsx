...
import { getProduct, createSales, getWarehouse } from "../../../services/ApiService";
import Input from "../../Input/Input";
import "../Form.css";
import { salesSchema } from "../../../validation/SalesValidation";
...
export default function SalesForm({ onSuccess }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="product-form">
      ...
      <div className="form-group">
        <select className="product-form-select" name="warehouseId" value={form.warehouseId} onChange={handleChange}>
