  ...
  return (
    ...
    >
      ...
      >
        {comments.length > 0
          ? comments.map((c, i) => {
              const isMine = c.username === currentUser;
              return (
                <div
                  key={i}
                  style={{
                    alignSelf: isMine ? "flex-end" : "flex-start",
                    background: isMine ? "#dcf8c6" : "#ffffff", // WhatsApp green vs white
                    padding: "8px 12px",
                    borderRadius: "12px",
                    maxWidth: "80%",
                ...
                >
                  <div
                    style={{
                      ...
                      fontSize: "0.75rem",
                      color: isMine ? "#4baf50" : "#075e54",
                      marginBottom: "4px",
                      fontWeight: "bold"
                    }}
                  >
                    <span>{isMine ? "You" : c.username}</span>
                  </div>
                  <div
                    style={{
                      fontSize: "0.95rem",
          ...
          : <div style={{textAlign: "center", color: "#888", marginTop: "20px"}}>No messages yet.</div>}
      </div>
